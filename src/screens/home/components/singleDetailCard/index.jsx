...
const SingleDetailCard = ({ productData, handleModal }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-start justify-between flex-wrap border p-4 rounded-xl cursor-pointer group relative">
      ...
      ></Link>
      <div className="z-20 flex items-center justify-center gap-x-8 md:gap-x-14 absolute w-full bottom-0 sm:bottom-16 group-hover:-translate-y-2 sm:group-hover:-translate-y-8 duration-300 opacity-0 group-hover:opacity-100 transition pointer-events-none group-hover:pointer-events-auto">
        <span
